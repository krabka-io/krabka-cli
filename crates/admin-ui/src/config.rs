...
pub struct AdminUiRuntimeArgs {
    ...
    #[arg(
        long,
        env = "KRABKA_ADMIN_UI_MUTATION_JSON_BODY_LIMIT",
        default_value = "1MiB",
    ...
    #[arg(
        long,
        env = "KRABKA_ADMIN_UI_SESSION_TTL",
        default_value = "8h",
    ...
    #[arg(
        long,
        env = "KRABKA_ADMIN_UI_TOPIC_MUTATION_TIMEOUT",
        default_value = "30s",
...
pub enum ConfigError {
    ...
    MissingBootstrap,
    #[error("KRABKA_ADMIN_UI_BOOTSTRAP contains an invalid address: {0}")]
    ...
    #[error(
        "KRABKA_ADMIN_UI_TLS_CLIENT_CERT_PEM and KRABKA_ADMIN_UI_TLS_CLIENT_KEY_PEM must be set together"
    )]
